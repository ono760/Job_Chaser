...
exports.down = function (knex, Promise) {
    return Promise.all([knex.schema.dropTable('reviews'), knex.schema.dropTable('interview_questions'), knex.schema.dropTable('user_job_stages'), knex.schema.dropTable('user_jobs'), knex.schema.dropTable('jobs'), knex.schema.dropTable('companies'), knex.schema.dropTable('users')]);
};

//# sourceMappingURL=migrations-compiled.js.map